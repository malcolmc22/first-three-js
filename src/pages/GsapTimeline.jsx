...
const GsapTimeline = () => {
  ...
  // timeline is used to manage multiple animations
  // it similar to to, from, and fromTO but the difference is it can manage all of them
  // when creating a timeline the first thing you have to do is define it
  // then you give it the options object to give it properties
  ...
  return (
    <main>
      ...
      <div className="mt-20 space-y-10">
        <button onClick={() => {
          // can manipulate and pause/play the animation whenever you want
          if (timeline.paused()) {
            timeline.play();
          } else{
            timeline.pause();
